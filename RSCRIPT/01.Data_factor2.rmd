...
# export to CSV file
write.csv(raw_data, "/Users/Andrew-MB/DEV/05.GIT/GSCIT-sns-sentiment/MODEL/data/lstm_data171031.csv", row.names=FALSE)
...
test_df$text <- lapply(df$text, function(x) {
  return(utf8ToInt(x))
})
